...
class Configuration < ActiveRecord::Base
  ...
  belongs_to :barclamp
  has_many  :instances, :class_name => "ConfigurationInstance", :inverse_of => :conifguration

  belongs_to :active_config, :class_name => "ProposalInstance", :foreign_key => "active_config_id"
  belongs_to :current_config, :class_name => "ProposalInstance", :foreign_key => "current_config_id"
