...
class CreateNavs < ActiveRecord::Migration
  def self.up
    ...
    Nav.find_or_create_by_item :item=>'nodes', :parent_item=>'root', :name=>'nav.nodes', :description=>'nav.nodes_description', :path=>"nodes_path", :order=>1000
      Nav.find_or_create_by_item :item=>'nodes_child', :parent_item=>'nodes', :name=>'nav.nodes', :description=>'nav.nodes_description', :path=>"nodes_path", :order=>1000
    ...
    Nav.find_or_create_by_item :item=>'deploy', :parent_item=>'root', :name=>'nav.deployments', :description=>'nav.deployments_description', :path=>"deployments_path", :order=>2000
      Nav.find_or_create_by_item :item=>'deploy_child', :parent_item=>'deploy', :name=>'nav.deployments', :description=>'nav.deployments_description', :path=>"deployments_path", :order=>1000
      ...
      Nav.find_or_create_by_item :item=>'annealer', :parent_item=>'deploy', :name=>'nav.annealer', :description=>'nav.annealer_description', :path=>"annealer_path", :order=>2000
    ...
    Nav.find_or_create_by_item :item=>'utils', :parent_item=>'root', :name=>'nav.utils', :description=>'nav.utils_description', :path=>"utils_path", :order=>6000
      Nav.find_or_create_by_item :item=>'utils_child', :parent_item=>'utils', :name=>'nav.utils', :description=>'nav.utils_description', :path=>"utils_path", :order=>100
    ...
    Nav.find_or_create_by_item :item=>'help', :parent_item=>'root', :name=>'nav.help', :description=>'nav.help_description', :path=>"docs_path", :order=>9999
      Nav.find_or_create_by_item :item=>'help_child', :parent_item=>'help', :name=>'nav.help', :description=>'nav.help_description', :path=>"docs_path", :order=>100
